...
# Input Files
SAMPLES=../../DATA/tara.new.freeze.samples

# Output Directory
OUT=../../DATA/metaSNV_res/tara.new.freeze.metasnv # use "output" not "output/"
...
# Filtering :
python ~/DEV_METASNV/metaSNV_Filtering_2.0.py "${OUT}" -m 5 -d 10 -b 40 -p 0.9 --n_threads $threads

# Compute distances :
python ~/DEV_METASNV/metaSNV_DistDiv.py --filt $OUT/filtered-m5-d10-b40-p0.9 --dist --n_threads $threads
