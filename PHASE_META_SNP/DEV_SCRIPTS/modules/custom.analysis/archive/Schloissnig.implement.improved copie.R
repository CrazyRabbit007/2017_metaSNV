...
i = species
# Loading the data
#table.species = fread(paste0("/science/paolil/TARA_metaSNP/tara_4_metaSNP/filtered",dist.dir,"/pop/",i,dist,".filtered.freq"))
...
res[,value:=pairwise.comp(id,variable,table.species),by=row.names(res)]
...
# Writing the file
write.table(gen.dist.species,paste0(i,dist,".genetic.distance.tab"),sep="\t")
