...
if __name__ == "__main__":
    ...
    if not os.path.exists(filt_folder + '/pop/'):
        os.makedirs(filt_folder + '/pop/')

    filter_two(args, snp_header,glob.glob(args.projdir + '/snpCaller/called*'),filt_folder + '/pop')
    
    if args.ind:
        if not os.path.exists(filt_folder + '/ind/'):
            os.makedirs(filt_folder + '/ind/')
        filter_two(args, snp_header,glob.glob(args.projdir + '/snpCaller/indiv*'),filt_folder + '/ind')
