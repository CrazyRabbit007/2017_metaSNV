...
def computeStats(args):
    ...
    bedfile_tab = data = pd.read_table('freeze11.marine.repgenomes.annotations.txt', index_col=0, header =None,usecols=[1,5])
    ...
    for f in allFreq:
        ...
        genome_length = int(data.loc[list_genes].sum())
